...
public class Item {
	...
	public static Item obsidianArmor0 = (new ItemArmor(89, 4, 5, 0)).setIconIndex(144);
	public static Item obsidianArmor1 = (new ItemArmor(90, 4, 5, 1)).setIconIndex(160);
	public static Item obsidianArmor2 = (new ItemArmor(91, 4, 5, 2)).setIconIndex(176);
	public static Item obsidianArmor3 = (new ItemArmor(92, 4, 5, 3)).setIconIndex(192);
	public static Item obsidianSword = (new ItemSword(93, 5)).setIconIndex(145);
	public static Item obsidianShovel = (new ItemSpade(94, 5)).setIconIndex(161);
	public static Item obsidianPick = (new ItemPickaxe(95, 5)).setIconIndex(177);
	public static Item obsidianAxe = (new ItemAxe(96, 5)).setIconIndex(193);
	public static Item obsidianHoe = (new ItemHoe(97, 5)).setIconIndex(209);
	public static Item obsidianIngot = (new Item(98)).setIconIndex(208);
	public static Item blackDye = (new Item(99)).setIconIndex(146);
	public static Item greenDye = (new Item(100)).setIconIndex(147);
	public static Item blueDye = (new Item(101)).setIconIndex(148);
	public static Item pinkDye = (new Item(102)).setIconIndex(149);
	public static Item fryshroom = (new ItemFood(103, 6)).setIconIndex(162);
