...
public class GuiMainMenu extends GuiScreen {
	...
	private String[] splashes = new String[]{"§athis one is even better"};
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		GL11.glPopMatrix();
		String credit = "Copyright Mojang. Distribution strictly prohibited.";
		String moreCredit = "Client mod by Candela Matalogue";
		String evenMoreCredit = "Mappings/tools by MCPHackers";
		this.drawString(this.fontRenderer, credit, this.width - this.fontRenderer.getStringWidth(credit) - 2, this.height - 10, 0xFFFFFF);
		this.drawString(this.fontRenderer, moreCredit, this.width - this.fontRenderer.getStringWidth(moreCredit) - 2, this.height - 20, 0xFFFFFF);
		this.drawString(this.fontRenderer, evenMoreCredit, this.width - this.fontRenderer.getStringWidth(evenMoreCredit) - 2, this.height - 30, 0xFFFFFF);
			...
			for(int var5 = 0; var5 < this.logoBlockLayers.length; ++var5) {
				for(int var6 = 0; var6 < this.logoBlockLayers[var5].length(); ++var6) {
					if(this.logoBlockLayers[var5].charAt(var6) != 32) {
						...
						var4.renderBlockAsItem(Block.imgur9F0A3un, var10);
						GL11.glPopMatrix();
					}
				}
			}
