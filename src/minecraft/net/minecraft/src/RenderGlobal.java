...
public class RenderGlobal implements IWorldAccess {
	...
	public void renderSky(float var1) {
		...
		var6 = (float)(1000L - Math.abs(23000L - this.theWorld.worldTime % 24000L)) / 1000.0F;
		...
		var16.addVertexWithUV(-30.0D, 100.0D, -30.0D, 0.0D, 0.0D);
		var16.addVertexWithUV(30.0D, 100.0D, -30.0D, 1.0D, 0.0D);
		var16.addVertexWithUV(30.0D, 100.0D, 30.0D, 1.0D, 1.0D);
		var16.addVertexWithUV(-30.0D, 100.0D, 30.0D, 0.0D, 1.0D);
		var16.draw();
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.renderEngine.getTexture("/terrain/moon.png"));
		var16.startDrawingQuads();
		var16.addVertexWithUV(-20.0D, -100.0D, 20.0D, 1.0D, 1.0D);
		var16.addVertexWithUV(20.0D, -100.0D, 20.0D, 0.0D, 1.0D);
		var16.addVertexWithUV(20.0D, -100.0D, -20.0D, 0.0D, 0.0D);
		var16.addVertexWithUV(-20.0D, -100.0D, -20.0D, 1.0D, 0.0D);
		var16.draw();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
	...
	public void playRecord(String var1, int var2, int var3, int var4) {
		if(var1 != null) {
			this.mc.ingameGUI.setRecordPlayingMessage(var1);
		}
