...
public abstract class Minecraft implements Runnable {
	...
	public ClientSettings coptions;
	...
	public void startGame() throws LWJGLException {
		...
		this.coptions = new ClientSettings(this, this.mcDataDir);
	...
	public int spd = 15;
	public boolean shouldRainbow;
	public boolean shouldCoords;
	public boolean shouldSpeed;
	public boolean shouldInjortrollcraft;
	public boolean shouldTrollChunks;
	...
	public void runTick() {
		...
		shouldRainbow = Boolean.parseBoolean(String.valueOf(this.coptions.getValue(0)));
		shouldCoords = Boolean.parseBoolean(String.valueOf(this.coptions.getValue(1)));
		shouldSpeed = Boolean.parseBoolean(String.valueOf(this.coptions.getValue(2)));
		shouldInjortrollcraft = Boolean.parseBoolean(String.valueOf(this.coptions.getValue(3)));
		shouldTrollChunks = Boolean.parseBoolean(String.valueOf(this.coptions.getValue(4)));
		...
		if (shouldRainbow) {
			if (this.r == 255 && this.g < 255 && this.b == 0) {
	            this.g += this.spd;
	        } else if (this.r >= 1 && this.g >= 255 && this.b == 0) {
	            this.r -= this.spd;
	        } else if (this.r == 0 && this.g >= 255 && this.b < 255) {
	            this.b += this.spd;
	        } else if (this.r == 0 && this.g >= 1 && this.b >= 255) {
	            this.g -= this.spd;
	        } else if (this.r < 255 && this.g == 0 && this.b >= 255) {
	            this.r += this.spd;
	        } else if (this.r >= 255 && this.g == 0 && this.b >= 1) {
	            this.b -= this.spd;
		...
		this.rainbowColor = getIntFromColor(r, g, b);
				...
				if(InputHandler.GetKBEventKeyState()) {
					if(InputHandler.GetKBEventKey() == 87) {
						...
						if(this.currentScreen != null) {
							...
							if(InputHandler.GetKBEventKey() == this.options.keyBindChat.keyCode) {
